...
const YoutubeUploadForm = ({ data }) => {
  ...
  const handleStatVisibleChange = (value) => {
    setFormDataYT({ ...formDataYT, publicStatsVisible: value });
  };
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input your video description!",
              },
            ]}
          ...
          <Form.Item label="Show Satistics Information to Public">
            <Switch
              ...
              checkedChildren="Yes"
              unCheckedChildren="No"
              onChange={handleStatVisibleChange}
            />
          </Form.Item>
          ...
          <Form.Item label="Notify Subscriber">
            <Switch
              ...
              checkedChildren="Yes"
              unCheckedChildren="No"
              onChange={handleNotifySubscriberChange}
            />
          </Form.Item>
