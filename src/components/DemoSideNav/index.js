...
const DemoSideNav = ({ user }) => {
  ...
  const mobileToggleState = useSelector(
    (state) => state.mobileToggleReducer.isMobileMenuOpen
  );
      ...
      <nav className={mobileToggleState ? "sidenav sidenav-active" : "sidenav"}>
        <div className="right-menu">
          <div className="right-menu-top">
            <div className="right-menu-userinfo">
              <span
              ...
              >
                ...
                <div className="prof-right-content">
                  <a
                    className="prof-name"
                    href={`${process.env.REACT_APP_WEB_HOST}/clan_profile`}
                  >
                    {user?.brand?.name && (
                  ...
                  {user.user_type == "influencer" &&
                    user.subscription_plan_name == "Free" && (
                      <div className="subs-header">
                        <a
                          href={`${process.env.REACT_APP_WEB_HOST}/influencer/orders/subscription`}
                          target="_blank"
                        >
                          Limited access, Go Premium
                        </a>
                      </div>
                    )}
                  ...
                  {user.user_type == "influencer" &&
                    ...
                    user.subscription_plan_name !== "Free" && (
                      <div className="subs-header premium">
                        {" "}
                        <span>Premium {user.plan_validity} days left.</span>
            ...
            <ul>
              ...
              <li className="link-li">
                <a href="/influencer/view_profile" className="link-item">
                  <Icon.Person size={20} />
                  <span className="inner-menu-text">
                    View profile
                    <span>(as seen by brands)</span>
                  </span>
                </a>
              </li>
            </ul>
